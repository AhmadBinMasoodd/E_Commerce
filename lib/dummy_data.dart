...
class UDummyData {
  ...
  static final List<BrandModel> brands = [
    BrandModel(
      id: '1',
      image: 'https://res.cloudinary.com/dstecodon/image/upload/v1772185001/Brands%20Pictures/fhgds734mc7dasxggefc.png',
      name: 'Nike',
      productCount: 2,
      isFeatured: true,
    ),
    BrandModel(
      id: '2',
      image: 'https://res.cloudinary.com/dstecodon/image/upload/v1772185003/Brands%20Pictures/vy2nghrzzfotj2x3qrre.jpg',
      name: 'Adidas',
      productCount: 2,
      isFeatured: true,
    ),
    BrandModel(
      id: '3',
      image: 'https://res.cloudinary.com/dstecodon/image/upload/v1772185005/Brands%20Pictures/c0hoymgsqtznhm6zxnes.jpg',
      name: 'Apple',
      productCount: 8,
      isFeatured: true,
    ),
    BrandModel(
      id: '4',
      image: 'https://res.cloudinary.com/dstecodon/image/upload/v1772185006/Brands%20Pictures/qvac66dx4tactvjye0is.png',
      name: 'Bata',
      productCount: 4,
      isFeatured: true,
    ),
    BrandModel(
      id: '5',
      image: 'https://res.cloudinary.com/dstecodon/image/upload/v1772185007/Brands%20Pictures/u66xqpkeew9drlkxw9f7.png',
      name: 'Bloody',
      productCount: 9,
      isFeatured: false,
    ),
    BrandModel(
      id: '6',
      image: 'https://res.cloudinary.com/dstecodon/image/upload/v1772185008/Brands%20Pictures/gafj8iluqia5r9jtbo2p.jpg',
      name: 'Breakout',
      productCount: 7,
      isFeatured: true,
    ),
    BrandModel(
      id: '7',
      image: 'https://res.cloudinary.com/dstecodon/image/upload/v1772185008/Brands%20Pictures/bgruxonk3proogdkcyvc.png',
      name: 'Dari Mooch',
      productCount: 4,
      isFeatured: true,
    ),
    BrandModel(
      id: '8',
      image: 'https://res.cloudinary.com/dstecodon/image/upload/v1772185009/Brands%20Pictures/jbgh7xsujq5hlylrun0m.jpg',
      name: 'Interwood',
      productCount: 9,
      isFeatured: false,
    ),
    BrandModel(
      id: '9',
      image: 'https://res.cloudinary.com/dstecodon/image/upload/v1772185010/Brands%20Pictures/j7wu1obrlkwbqknqaqtx.jpg',
      name: 'HP',
      productCount: 4,
      isFeatured: false,
    ),
    BrandModel(
      id: '10',
      image:'https://res.cloudinary.com/dstecodon/image/upload/v1772185011/Brands%20Pictures/jgdydbya03kom3dpnbal.png',
      name: 'J.',
      productCount: 8,
      isFeatured: true,
    ),
    BrandModel(
      id: '11',
      image: 'https://res.cloudinary.com/dstecodon/image/upload/v1772185011/Brands%20Pictures/s9lycjany50awtzc5kjh.png',
      name: 'NDURE',
      productCount: 4,
      isFeatured: true,
    ),
    BrandModel(
      id: '12',
      image: 'https://res.cloudinary.com/dstecodon/image/upload/v1772185012/Brands%20Pictures/padtgomdmgpfp8jwmjmz.jpg',
      name: 'NorthStar',
      productCount: 2,
      isFeatured: true,
    ),
    BrandModel(
      id: '13',
      image:'https://res.cloudinary.com/dstecodon/image/upload/v1772185013/Brands%20Pictures/zt5bfs7vorl4bxrbvl1x.png',
      name: 'Polo',
      productCount: 2,
      isFeatured: true,
    ),
